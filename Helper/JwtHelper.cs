...
public class JwtHelper
{
    ...
    public string GenerateToken(AccountItem accountItem)
    {
        ...
        claims.Add(new Claim(JwtRegisteredClaimNames.Sub, accountItem.Email)); // User.Identity.Name
        claims.Add(new Claim("accountId", accountItem.Id));
